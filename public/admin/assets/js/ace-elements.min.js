...
function(e) {
	...
	e.fn.ace_tree = function(i) {
		...
		this.each(function() {
			var i = e(this);
			var html ='<div class="tree-folder" style="display:none;">				<div class="tree-folder-header">					<i class="' + ace.vars.icon + t["close-icon"] + '"></i>					<div class="tree-folder-name"></div>				</div>				<div class="tree-folder-content"></div>				<div class="tree-loader" style="display:none"></div>			</div>			<div class="tree-item" style="display:none;">				' ;
			if(t.gengruifeng == false){
				html +='				<div class="tree-item-name"></div>			</div>';
			}else{
				html += (null == t["unselected-icon"] ? "": '<i class="' + ace.vars.icon + t["unselected-icon"] + '"></i>') + '				<div class="tree-item-name"></div>			</div>';
			}
			i.html(html),
