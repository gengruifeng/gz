...
(function(b, d) {
	...
	var c = function(f, e) {
		...
		this));
		this.render()
		// this.$element.find(".tree-folder-header").each(function(k,v){
		// 	$(this).trigger("click"); 
		// })
	};
	c.prototype = {
			...
			function(i) {
				...
				function(j, m) {
					...
					if (m.type === "folder") {
						...
						if(f.options.gengruifeng == false){
							k.find(".tree-folder-name").html(m.name+'<span style="float:right"><a onclick="addcon(this,'+m.additionalParameters.id+','+m.level+')" href="javascript:void(0)">添加</a>|<a onclick="editcon(this,'+m.additionalParameters.id+','+m.level+')" href="javascript:void(0)">编辑</a>|<a onclick="del('+m.additionalParameters.id+')" href="javascript:void(0)">删除</a></span>');
						...
						if (m.type === "item") {
							...
							if(f.options.gengruifeng == false){
								if(m.level == 3){
									k.find(".tree-item-name").html(m.name+'<span style="float:right"><a onclick="editcon(this,'+m.additionalParameters.id+','+m.level+')" href="javascript:void(0)">编辑</a>|<a onclick="del('+m.additionalParameters.id+')" href="javascript:void(0)">删除</a></span>');
								}else{
									k.find(".tree-item-name").html(m.name+'<span style="float:right"><a onclick="addcon(this,'+m.additionalParameters.id+','+m.level+')" href="javascript:void(0)">添加</a>|<a onclick="editcon(this,'+m.additionalParameters.id+','+m.level+')" href="javascript:void(0)">编辑</a>|<a onclick="del('+m.additionalParameters.id+')" href="javascript:void(0)">删除</a></span>');
								}
							}else{
