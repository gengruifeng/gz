			...
			<div class="modal-content">
				...
				<form class="form-horizontal" id="answerFrom" onsubmit="return false" method="post" action="{{ url('admin/ajax/competence/add') }}">
					...
					<div id="notong" class="form-group">
						...
						<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="name">回答内容：</label>
						<div class="col-xs-12 col-sm-9" style="width:600px">
							<div class="clearfix">
								<textarea id="reason" name="detail" class="form-control"></textarea>
							</div>
						</div>
					</div>
...
@section('javascripts')
	...
	<script src="{{ asset('admin/js/answered.js') }}"></script>
	<script>
