...
<section id="section">
    ...
    <!--内容开始-->
    <!--发布问题开始-->
    <form class="release" id="article-form" action="/ajax/articles">
        <div>
            <input type="text" placeholder="请输入您的文章标题" id="subject" onkeyup="checkMaxInput(this,'inputnumber',50)" onkeydown="checkMaxInput(this,'inputnumber',50)"/>
            <p>还可以输入
...
<!--提示层 开始-->
<div class="shadows-tips shadows-article hide">
    <div class="inner">
