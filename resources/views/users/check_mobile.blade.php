...
<div class="vlogin loginReMobile2">
    <div class="inner">
        <a href="{{url('/')}}"><h1></h1></a>
        <form action=""  method="post" id="loginMobileNum-form" autocomplete="off">
            <!-- 信息相关 开始 -->
            <div class="tp">
                <div class="testwap">
                    <div class="inp inpMobile"><input type="text" id="mobile" name="mobile" placeholder="您的手机号"></div>
                </div>
                <div class="clearfix regestypeChange"><a href="{{url('/registeremail')}}" class="fr">使用邮箱注册</a></div>
                {{ csrf_field() }}
